...
const Settings = {
  ...
  defaults: {
    ...
    smoothScroll: true,
      ...
      `\
unmapAll
map <c-a-q> LinkHints.activateModeToOpenInNewForegroundTab
map <c-a-z> LinkHints.activateMode
map <c-a-a> LinkHints.activateModeToOpenInNewTab
map <c-a-s> LinkHints.activateModeToCopyLinkUrl
map <c-a-w> moveTabToNewWindow
map <c-a-d> duplicateTab
map <c-a-/> focusInput
map <c-a-x> focusInput
map <c-a-r> Vomnibar.activateTabSelection
map <a-\`> passNextKey
map <a-~> enterInsertMode
map <c-a-@> scrollFullPageUp
map <c-a-#> scrollFullPageDown
map <c-a-W> scrollPageUp
map <c-a-E> scrollPageDown
map <c-a-S> scrollUp
map <c-a-D> scrollDown
map <c-a-~> nextFrame
map <c-a-!> mainFrame
map <c-a-=> enterFindMode
map <c-a-k> performFind
map <c-a-j> performBackwardsFind
map <c-a-v> enterVisualMode
map <c-a-V> enterVisualLineMode
map <c-a-M> toggleMuteTab
# Vimium 'escape' cannot be remapped. At least add map to escape Vimium without escaping site.
mapkey <c-a-\`> <c-[>\
`,
    /*linkHintCharacters: "123qweasd",*/
    linkHintCharacters: "1234QWEASFZXCV",
...
`,
    ...
    exclusionRules:
      [
        ...
        //itaj@@incomplete { pattern: "https?://mail.google.com/*", passKeys: "" }
          { pattern: "https?://remotedesktop.google.com/access/session/*", passKeys: "" },
          { pattern: "https?://docs.google.com/*edit*", passKeys: "" }
     ],
